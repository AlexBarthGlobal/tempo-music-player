...
const NewCollectionSongs = (props) => {
    ...
    const [editedCollectioName, setEditedCollectionName] = useState(props.musicInfo.collections[props.selectedCollection].collectionName)
            ...
            <div className='screenTitle'>
                <div>
                    {props.editMode ? <Input className='browseSongsInput'
                        ...
                        }} inputProps={{spellCheck: false, style: {textAlign: 'center'}}} name='editedCollectionName' /*onFocus={this.clearNameOnFocus} value={this.state.editedCollectionName} onChange={this.handleChange} variant="outlined"*/ /> : /*this.state.collectionName*/ 'Collection Name'}
                </div>
                <div>
...
export default connect(mapStateToProps, mapDispatchToProps)(NewCollectionSongs)